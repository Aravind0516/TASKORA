...
export function AdminProjectsView() {
  ...
  function handleSubmit(values: PlatformProjectFormValues) {
    ...
    if (editingProject) {
      ...
      updateProject(editingProject.id, { ...values, memberIds, managerId, organizationId: currentOrganizationId });
      ...
      createProject({ organizationId: currentOrganizationId, ...values, memberIds, managerId, ownerId: user.uid });
