...
export const organizations: Organization[] = [
  {
    ...
    trialStartedAt: "2025-11-02T09:00:00.000Z",
    trialEndsAt: "2025-11-17T09:00:00.000Z",
    subscriptionStartedAt: "2025-11-17T09:00:00.000Z",
    subscriptionEndsAt: "2026-10-17T09:00:00.000Z",
    status: "Active",
    adminId: "padmin-1",
  ...
  },
  {
    ...
    plan: "CRAZY",
    subscriptionStatus: "ACTIVE",
    trialStartedAt: "2025-08-14T09:00:00.000Z",
    trialEndsAt: "2025-08-29T09:00:00.000Z",
    subscriptionStartedAt: "2025-08-29T09:00:00.000Z",
    subscriptionEndsAt: "2026-10-29T09:00:00.000Z",
    status: "Active",
    adminId: "padmin-2",
  ...
  },
  {
    ...
    trialStartedAt: "2026-08-25T09:00:00.000Z",
    trialEndsAt: "2026-09-09T09:00:00.000Z",
  ...
  },
  {
    ...
    plan: "PREMIUM",
    subscriptionStatus: "ACTIVE",
    trialStartedAt: "2025-05-30T09:00:00.000Z",
    trialEndsAt: "2025-06-14T09:00:00.000Z",
    subscriptionStartedAt: "2025-06-14T09:00:00.000Z",
    subscriptionEndsAt: "2026-10-14T09:00:00.000Z",
    status: "Suspended",
    adminId: "padmin-4",
...
export const platformProjects: PlatformProject[] = [
  { id: "pproj-1", organizationId: "org-1", teamId: "pteam-1", name: "Gen3 Actuator Platform", description: "Next-generation actuator module for warehouse arms.", ownerId: "puser-1", managerId: null, memberIds: [], status: "Active", priority: "High", progress: 62, startDate: "2026-06-01", dueDate: "2026-10-15", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-05-20T09:00:00.000Z", updatedAt: "2026-09-03T10:00:00.000Z" },
  { id: "pproj-2", organizationId: "org-1", teamId: "pteam-2", name: "Firmware OTA Rollout", description: "Staged OTA firmware delivery across the robotics fleet.", ownerId: "puser-3", managerId: null, memberIds: [], status: "Active", priority: "Critical", progress: 40, startDate: "2026-07-01", dueDate: "2026-09-20", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-06-15T09:00:00.000Z", updatedAt: "2026-09-04T09:00:00.000Z" },
  { id: "pproj-3", organizationId: "org-2", teamId: "pteam-3", name: "Realtime Analytics Pipeline", description: "Streaming ingestion pipeline for customer event data.", ownerId: "puser-6", managerId: null, memberIds: [], status: "Active", priority: "High", progress: 78, startDate: "2026-04-01", dueDate: "2026-09-25", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-03-20T09:00:00.000Z", updatedAt: "2026-09-05T08:00:00.000Z" },
  { id: "pproj-4", organizationId: "org-2", teamId: "pteam-4", name: "Customer Insights Portal", description: "Self-serve analytics portal for enterprise customers.", ownerId: "puser-8", managerId: null, memberIds: [], status: "Planning", priority: "Medium", progress: 15, startDate: "2026-09-01", dueDate: "2026-12-15", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-08-20T09:00:00.000Z", updatedAt: "2026-09-02T09:00:00.000Z" },
  { id: "pproj-10", organizationId: "org-2", teamId: "pteam-3", name: "Data Governance Audit", description: "Compliance audit and access-control cleanup.", ownerId: "puser-10", managerId: null, memberIds: [], status: "On Hold", priority: "Low", progress: 25, startDate: "2026-05-01", dueDate: "2026-09-30", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-04-25T09:00:00.000Z", updatedAt: "2026-08-28T09:00:00.000Z" },
  { id: "pproj-5", organizationId: "org-3", teamId: "pteam-6", name: "Aurora Rebrand", description: "Full brand identity refresh for a fintech client.", ownerId: "puser-13", managerId: null, memberIds: [], status: "Active", priority: "High", progress: 55, startDate: "2026-07-15", dueDate: "2026-09-10", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-07-01T09:00:00.000Z", updatedAt: "2026-09-04T14:00:00.000Z" },
  { id: "pproj-6", organizationId: "org-3", teamId: "pteam-5", name: "Design System 2.0", description: "Componentized design system for internal product teams.", ownerId: "puser-11", managerId: null, memberIds: [], status: "Active", priority: "Medium", progress: 33, startDate: "2026-06-01", dueDate: "2026-10-01", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-05-25T09:00:00.000Z", updatedAt: "2026-09-01T09:00:00.000Z" },
  { id: "pproj-7", organizationId: "org-4", teamId: "pteam-7", name: "Fleet Telemetry Upgrade", description: "Next-gen telemetry hardware rollout across the fleet.", ownerId: "puser-16", managerId: null, memberIds: [], status: "On Hold", priority: "Medium", progress: 48, startDate: "2026-03-01", dueDate: "2026-09-30", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2026-02-15T09:00:00.000Z", updatedAt: "2026-08-22T09:00:00.000Z" },
  { id: "pproj-8", organizationId: "org-4", teamId: "pteam-8", name: "Warehouse Automation Rollout", description: "Automated pick-and-pack integration.", ownerId: "puser-18", managerId: null, memberIds: [], status: "On Hold", priority: "High", progress: 70, startDate: "2026-01-10", dueDate: "2026-09-15", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2025-12-20T09:00:00.000Z", updatedAt: "2026-08-21T09:00:00.000Z" },
  { id: "pproj-9", organizationId: "org-4", teamId: "pteam-7", name: "Cold Chain Monitoring", description: "Temperature-compliance monitoring for refrigerated freight.", ownerId: "puser-20", managerId: null, memberIds: [], status: "Completed", priority: "Critical", progress: 100, startDate: "2025-11-01", dueDate: "2026-04-01", archived: false, repositoryUrl: null, repositoryProvider: "NONE", workVerificationEnabled: false, verificationFrequency: "DAILY", createdAt: "2025-10-15T09:00:00.000Z", updatedAt: "2026-04-01T09:00:00.000Z" },
];
